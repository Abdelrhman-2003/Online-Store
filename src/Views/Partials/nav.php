                ...
                <div class="flex h-16 items-center">
                    ...
                    <div class="ml-4 flex lg:ml-0">
                        <a href="#">
                            ...
                            <img class="h-40 w-auto" src="https://graphicsfamily.com/wp-content/uploads/edd/2020/12/Free-Logo-Design-Template-for-Online-Store-PNG-transparent.png" alt="" />
                        </a>
                    </div>
                    <!-- Flyout menus -->
                    <div class="hidden lg:ml-8 lg:block lg:self-stretch ">
                        <div class="flex h-full space-x-8 ">
                            ...
                            <div class="flex">
                                <div class="relative flex">
                                    <div class="relative flex items-center">
                                        <a href="#clothies">Clothies Category</a>
                                    </div>
                                </div>
                            </div>
                            <div class="flex">
                                <div class="relative flex">
                                    <div class="relative flex items-center">
                                        <a href="#technology">Technology Category</a>
                                    </div>
                                </div>
                            </div>

                            <div class="flex">
                                <div class="relative flex items-center w-2">
                                    <a href="#vegfru">Vegetables&Fruits Category</a>
                                </div>
                            </div>
                        </div>
                    </div>
